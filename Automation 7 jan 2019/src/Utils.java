...
public class Utils {
	...
	public void checkEnterEmail(AndroidDriver<AndroidElement> driver) {
		Assert.assertTrue(driver.findElement(By.xpath(Xpath.LoginScreenPath.EMAIL_EDIT_FIELD)).isDisplayed());

		new WebDriverWait(driver, 100)
				.until(ExpectedConditions.elementToBeClickable(By.xpath(Xpath.LoginScreenPath.EMAIL_EDIT_FIELD))).click();
		driver.findElement(By.xpath(Xpath.LoginScreenPath.EMAIL_EDIT_FIELD)).sendKeys(ConstantVariables.NEWEMAIL);
	}
	
	public void checkEnterPassword(AndroidDriver<AndroidElement> driver) {
		Assert.assertTrue(driver.findElement(By.xpath(Xpath.LoginScreenPath.PASSWORD_EDIT_FIELD)).isDisplayed());

		driver.findElement(By.xpath(Xpath.LoginScreenPath.PASSWORD_EDIT_FIELD))
